 ...
 */
class AddAttributePhoneCustomer implements DataPatchInterface
{
    /**
        ...
        try {
            ...
            $this->customerSetup->addAttribute(
                ...
                [
                    ...
                    'label' => 'Phone',
                    'input' => 'text',
                    'backend' => 'Magenest\Movie\Model\Attribute\Backend\PhoneCustomer',
                    'frontend'=>'',
                    'frontend_class' => 'phone-validate',
                    'required' => false,
                    'visible' => true,
                    'user_defined' => true,
                    'sort_order' => 100,
            ...
            $attribute = $this->customerSetup->getEavConfig()
                ->getAttribute(CustomerMetadataInterface::ENTITY_TYPE_CUSTOMER, 'phone');

            // Make attribute visible in Admin customer form
            $attribute->setData('used_in_forms', [
                'adminhtml_customer','customer_account_edit','customer_account','customer_account_create'
            ]);
